  ...
  return (
    <section className="py-20">
      <div className="max-w-6xl mx-auto px-4 md:px-8 text-center">
        ...
        <div className="w-24 h-1 bg-[#FCDA16] mx-auto mt-3 mb-8 rounded-sm" />
          ...
          {cards.map((card, i) => {
            ...
            return (
              <article
                ...
                className={`relative cursor-pointer rounded-md border-2 transition-all duration-200 ease-in-out overflow-hidden flex items-center justify-center h-64 md:h-72 p-6 ${
                  isActive
                    ? "bg-[#FCDA16] border-[#f1c900]"
                    : "bg-white border-[#f1c900]/50"
                }`}
              >
                ...
                {!isActive && (
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="absolute right-3 bottom-3 text-[#F4D03F] font-bold">
                      ➤
                    </div>
                  </div>
                )}
                ...
                {isActive && (
                  <div className="w-full h-full flex flex-col justify-between text-left p-6">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="w-16 h-0.5 bg-black mt-2 mb-2" />
                      </div>
                    </div>
